...
class World_Test < MiniTest::Test
  ...
  def setup
    ...
    @mock_blinker_world.board[2][1].revive
    @mock_blinker_world.board[2][2].revive
    @mock_blinker_world.board[2][3].revive
  end

  def test_that_a_new_world_is_the_correct_size
    world = World.new(5, 5)
    assert_equal(25, world.board.flatten.length)
  end
  ...
  def test_that_you_can_generate_a_board_of_random_cells
    world = World.new(5, 5)
  ...
  def test_that_you_can_set_a_cell_to_alive
    ...
    assert_equal(true, world.board[1][1].alive?)
  end
  ...
  def test_neighbor_to_the_right_of_a_cell_on_the_right_edge_wraps_to_the_left
    ...
    assert_equal(world.board[0][0], world.neighbors_of(0, 4)[1])
  end
  ...
  def test_neighbor_to_the_bottom_of_cell_on_the_bottom_of_the_world_will_wrap_to_the_top
    ...
    world.generate_random_cells
    refute_includes(world.neighbors_of(0, 4), nil)
    assert_equal(world.board[0][1], world.neighbors_of(4, 1)[2])
  end
  ...
  def test_neighbor_to_the_bottom_right_of_cell_on_the_bottom_right_edge_will_wrap_to_the_top_left_edge
    ...
    assert_equal(world.board[0][0], world.neighbors_of(4, 4)[3])
  end
  ...
  def test_an_alive_cell_will_be_dead_in_the_next_generation_if_overpopulated
    world = World.new(5, 5)
    world.generate_dead_cells
    world.board[1][3].revive
    world.board[1][1].revive
    world.board[1][2].revive
    world.board[0][2].revive
    world.board[2][2].revive
